...
NEW_WORDS_PER_DAY = int(os.environ.get("NEW_WORDS_PER_DAY", "27"))  # 25-30
...
# Соотношение технических/общих слов в ежедневной подборке (0.5 = 50/50)
TECHNICAL_SHARE = float(os.environ.get("TECHNICAL_SHARE", "0.5"))
